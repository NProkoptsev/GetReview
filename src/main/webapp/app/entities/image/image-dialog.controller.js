(function() {
    ...
    ImageDialogController.$inject = ['$timeout', '$scope', '$stateParams', '$uibModalInstance', 'entity', 'Image'];

    function ImageDialogController ($timeout, $scope, $stateParams, $uibModalInstance, entity, Image) {
        var vm = this;
